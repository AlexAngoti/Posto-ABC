object dm: Tdm
  ...
  object qryAbastecimento: TFDQuery
    ...
    object qryAbastecimentoDATA_ABAST: TSQLTimeStampField
    ...
    object qryAbastecimentoVALOR_TOTAL: TFMTBCDField
    ...
    object qryAbastecimentoIMPOSTO: TFMTBCDField
      FieldName = 'IMPOSTO'
      Origin = 'IMPOSTO'
      Required = True
      Precision = 18
  ...
  object cdsAbastecimento: TClientDataSet
    ...
    Left = 232
    Top = 8
    object cdsAbastecimentoDATA_ABAST: TSQLTimeStampField
      FieldName = 'DATA_ABAST'
      Required = True
    end
    ...
    object cdsAbastecimentoLITROS: TFMTBCDField
      FieldName = 'LITROS'
      Required = True
      Precision = 18
      Size = 3
    end
    object cdsAbastecimentoVALOR_TOTAL: TFMTBCDField
      FieldName = 'VALOR_TOTAL'
      Required = True
      Precision = 18
      Size = 2
    end
    object cdsAbastecimentoIMPOSTO: TFMTBCDField
      FieldName = 'IMPOSTO'
      Required = True
      Precision = 18
      Size = 2
  ...
  object cdsBomba: TClientDataSet
    ...
    object cdsBombaNOME: TStringField
      FieldName = 'NOME'
      Required = True
      Size = 50
    end
  ...
  object cdsTanque: TClientDataSet
    ...
    object cdsTanqueNOME: TStringField
      FieldName = 'NOME'
      Required = True
      Size = 50
    end
    object cdsTanqueTIPO: TStringField
      FieldName = 'TIPO'
      Required = True
      FixedChar = True
      Size = 1
